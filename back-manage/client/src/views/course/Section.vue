...
<!--            <span style="margin-left: 10px">{{ scope.row.title }}</span>-->
            <router-link :to="`/course/comment?sectionId=${scope.row.id}`" style="margin-left: 10px">{{ scope.row.title }}</router-link>
          </template>
        </el-table-column>
        <el-table-column
            label="描述"
        ...
        <el-table-column
            ...
            width="250">
          <template slot-scope="scope">
            <span style="margin-left: 10px">{{ scope.row.video }}</span>
          </template>
        </el-table-column>
        <el-table-column
            label="排序"
            ...
            width="100">
          <template slot-scope="scope">
            <span style="margin-left: 10px">{{ scope.row.section_num }}</span>
          </template>
        </el-table-column>
        <el-table-column
            label="创建时间"
...
export default {
  ...
  methods: {
    userInfo() {
      ...
      let url = `/api/course/section/all?pageNum=${this.paginations.pageIndex}&pageSize=${this.paginations.pageSize}&id=${id}`
