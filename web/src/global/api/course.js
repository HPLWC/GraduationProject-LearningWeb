...
export default {
  ...
  getTheUserCourseInfo: (params, config) => request('get', '/course/user/info/all', params, config), // 获取用户课程详情
  getTheUserInfo: (params, config) => request('get', '/get/user/course/info', params, config), // 获取用户课程详情
  getCourseAllSection: (params, config) => request('get', '/course/section/all', params, config), // 获取所有课程目录
  saveCourseSection: (params, config) => request('post', '/course/section/save', params, config), // 获取所有课程目录
  deleteCourseSection: (params, config) => request('delete', '/course/section/delete', params, config), // 删除课程目录
